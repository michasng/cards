...
import 'package:cards/screens/deck/components/deck_form.dart';
import 'package:cards/screens/deck/components/deck_view.dart';
...
class DeckScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(locale.deckName(deck.name))),
